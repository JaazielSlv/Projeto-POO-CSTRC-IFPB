...
Funciona como um navegador web simulado no terminal e, para isso, necessita de dois mecanismos fundamentais: um sistema de armazenamento das páginas e um controle de histórico de navegação.
